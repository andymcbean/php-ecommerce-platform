        ...
        foreach($result as $row)
            {
                ...
                $output .= '<tr>
                                ...
                                <td><a href="delete?order_no='.$row['order_no'].'&description='.$row['description'].'&size='.$row['size'].'" data-toggle="tooltip" data-placement="bottom" title="Remove items" type="submit" name="delete"><i class="fa fa-trash" style="color: #fe0400;"></a></td>
                            </tr>';
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <a href="../decoupage/" class="btn btn-info" id="keep_shopping"><span><i class="fas fa-trash"></i></span> Continue shopping</a>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            <div class="col-12">
                                ...
                                <input type="button" name="save" class="btn btn-info" value="Confirm delivery/collection details" id="butsave">
                            </div>
