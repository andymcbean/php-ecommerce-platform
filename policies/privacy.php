...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px; color: #fff" class="nav-icon">Terms of use</h1>
  </div>
</div>
<div class="container margin-top">
    <div class="row">
        ...
        <p>Our company is hosted with <a href="https://kingdomdesign.com" target="_blank">Kingdom Design</a>. <a href="https://kingdomdesign.com" target="_blank">Kingdom Design</a> provides us with the online platform that allows us to sell our products and services to you. Your data may be stored through <a href="https://kingdomdesign.com" target="_blank">Kingdom Design's</a> data storage, databases and the general <a href="https://kingdomdesign.com" target="_blank">Kingdom Design</a> applications. They store your data on secure servers behind a firewall. 
        All direct payment gateways offered by <a href="https://kingdomdesign.com" target="_blank">Kingdom Design</a> and used by our company adhere to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, MasterCard, American Express and Discover. PCI-DSS requirements help ensure the secure handling of credit card information by our store and its service providers.</p>
        ...
        <p>If you don’t want us to process your data anymore, please contact us at <a href="mailto:decoupagequeenpaper@gmail.com">decoupagequeenpaper@gmail.com</a>
        We reserve the right to modify this privacy policy at any time, so please review it frequently. Changes and clarifications will take effect immediately upon their posting on the website. If we make material changes to this policy, we will notify you here that it has been updated, so that you are aware of what information we collect, how we use it, and under what circumstances, if any, we use and/or disclose it. 
        If you would like to: access, correct, amend or delete any personal information we have about you, you are invited to contact us at <a href="mailto:decoupagequeenpaper@gmail.com">decoupagequeenpaper@gmail.com</a></p>
        </div>
    </div>
</div>
<?php
