...
<div class="hero-image">
  <div class="hero-text">
    <h1 style="font-size:50px; color: #fff" class="nav-icon">Incomplete Orders</h1>
  </div>
</div>
...
<div id="result"></div>
    ...
    <div class="row">
        ...
        <div class="col-3">
            <a class="btn btn-info" href="orders">Paid orders</a>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-md-3">  
            <input type="text" name="from_date_abdn" id="from_date_abdn" class="form-control" placeholder="From Date" />  
        </div>  
        <div class="col-md-3">  
            <input type="text" name="to_date_abdn" id="to_date_abdn" class="form-control" placeholder="To Date" />  
        </div>  
        <div class="col-md-3">  
    ...
    <input type="checkbox" id="hide-col">Hide irrelevant columns for CSV export?
    <div class="row mt-2">
    <div id="response"></div>
        <div class="col-12">
            <div id="order_table_country">
                <div id="order_table_data_abdn">
                    <div id="order_table_county">
                        <form id="pdf-form" action="pdf-print" method="post">
                        <table id="orders-table-abdn" class="table table-hover table-responsive sticky-header">
                            <thead>
                                <tr>
...
<script>     
    $('#downloadcsv').on('click', function(){
        $('#orders-table-abdn').TableCSVExport({
            delivery: 'download',
...
$(document).on('click',function(){
 ...
 <script>  
      $(document).ready(function(){  
           ...
           $(function(){  
                $("#from_date_abdn").datepicker();  
                $("#to_date_abdn").datepicker();  
           });  
           $('#filter').click(function(){  
                var from_date_abdn = $('#from_date_abdn').val();  
                var to_date_abdn = $('#to_date_abdn').val();  
                if(from_date_abdn != '' && to_date_abdn != '')  
                {  
                     $.ajax({  
                          url: 'filter',  
                          method: 'POST',  
                          data:{from_date:from_date_abdn, to_date_abdn:to_date_abdn},  
                          success:function(data)  
                          {  
                               $('#order_table_data_abdn').html(data);  
                          }  
                     });  
                }  
                else  
