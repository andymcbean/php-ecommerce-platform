...
<div class="container margin-top">
    <div class="row text-center" id="no-print">
        <div class="col-12">
            <a class="btn btn-info float-left mb-3" href="orders"><i class="fas fa-chevron-circle-left"></i> Back to orders</a>
        </div>
    </div>
    <div id="print">
        <div class="row">
    ...
    <div class="row mx-auto">
        ...
        if($dispatched == 0)
            {
                echo "<button class='btn btn-info mb-4 ml-2' id='dispatched'>Mark as Dispatched</button>";
            }
        elseif($dispatched == 1)
            {
                echo "This order has been dispatched";
            }
        ?>
