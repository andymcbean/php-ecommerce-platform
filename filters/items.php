                    ...
                    <div class='col-12 col-sm-6 col-lg-3 col-md-3 mb-5'>
                        <div class='card h-100'>
                            <div class='card-img-top'>
                                <a href="../decoupage/details?sku=<?php echo $row['sku'] ?>"><img src='<?php echo IMAGE_URL ?><?php echo $row['img'] ?>' alt='' class='img-fluid product-image' id='product_image'></a>
                            </div>
                            <div class='card-body'>
                                <!--<h4 style='text-align:center;' ><?php //echo $row['description'] ?></h4>-->
                                <h4 id="product_name" style='text-align: center;' class="product-title"><a href='../decoupage/details?sku=<?php echo $row['sku'] ?>' style="text-decoration: none; color: #000;"><?php echo $row['description'] ?></a></h4>
